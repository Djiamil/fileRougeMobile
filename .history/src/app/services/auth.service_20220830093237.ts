...
public url:'http://127.0.0.1:8000/api/login'
  ...
  gereCommandeALivrer(id:string){
    return this.http.put<any>('http://localhost:8000/api/livraisons/'+id,{
      "etatlivraison": "deja livrais"
    })
    .subscribe();
  }
  modifeEtaLivraisons(id:number){
    this.http.put<any>('http://localhost:8000/api/livraisons/'+id,{
      "etatlivraison": 'deja livrer'
    })
    .subscribe();
    // location.reload();
  }
